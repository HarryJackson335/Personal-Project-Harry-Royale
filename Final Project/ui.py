...
class UI:
    ...
    def display_spell_info(self):
        # bg
        rect = pygame.FRect(0, 0, 200, 400).move_to(bottomright = (self.left_padding, self.bottom_padding))
        pygame.draw.rect(self.screen, COLORS['white'], rect, 0, 4)

        text_font = pygame.font.Font(None, 36)
        text_surf = text_font.render(SPELLS, True, COLORS['black'], COLORS['white'])
    ...
    def draw(self, surface):
        match self.current_state:
            ...
            case 'view spells': self.display_spell_info()
